...
rule merge_fastq_paired:
    ...
    output:
        r1 = temp("processed/{tissue_real}/fastq/{mouse}_R1.fastq.gz"),
        r2 = temp("processed/{tissue_real}/fastq/{mouse}_R2.fastq.gz"),
    resources:
        runtime = '4h',
    shell:
        """
...
rule merge_fastq_single:
    ...
    output:
        temp("processed/{tissue}/fastq/{mouse}_SE.fastq.gz"),
    resources:
        runtime = '4h',
    shell:
        "cat {input} > {output}"
